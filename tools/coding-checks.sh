...
usage () {
  echo "Usage: $0 [OPTION]..."
  echo "Run pybluedot's coding check(s)"
  echo ""
  echo "  -Y, --pylint [<basecommit>] Run pylint check on the entire pybluedot module or just files changed in basecommit (e.g. HEAD~1)"
